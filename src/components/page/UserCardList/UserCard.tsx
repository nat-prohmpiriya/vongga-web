        ...
        <Card
            ...
            cover={
                <div className='relative bg-black ' style={{ height: '125px' }}>
                    {props.photoCover
                        ? <img alt="example" src={props.photoCover} className="w-full h-[125px] object-cover rounded-t-lg" />
                        : <div className='h-[125px] bg-black rounded-t-lg' />
                    }
                    {props.photoProfile
                        ? <Avatar size={64} src={props.photoProfile} className='absolute top-1/5 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hover:scale-105 transition-transform duration-300' />
                        : <Avatar size={64} icon={<UserOutlined />} className='absolute top-1/5 left-1/2 transform -translate-x-1/2 -translate-y-1/2' />
                    }
                </div>
