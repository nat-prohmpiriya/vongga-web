                ...
                <div className="flex flex-col bg-white rounded-xl p-3">
                    ...
                    </div>
                    {
                        notificationsData.map((notification: notificationResponseItem) => (
                            <div
                                key={notification.id}
                                className={`grid grid-cols-5 gap-4 cursor-pointer  my-3 border-b border-gray-200 p-2 ${!notification.isRead ? 'bg-red-50' : ''} `}
                            ...
                            >
                                ...
                                <div className="flex flex-col col-span-4 ml-2">
