    ...
    const relatedVideos = () => {
        return Array.from({ length: 10 }).map((_, index) => (
            <div key={uuidv4()} className="flex gap-2 mb-4 cursor-pointer">
                ...
                />
                <div>
                    <h3 className="font-medium text-sm">Video Title {index + 1}</h3>
                    <p className="text-gray-500 text-xs">Channel Name</p>
                    <p className="text-gray-500 text-xs">123K views • 2 days ago</p>
                </div>
            </div>
        ));
    };
    ...
    const comments = [
        {
            ...
            content: 'เห็นเวิ่นๆเชยจระทำสามารถีวิตรมแม่น้ำไง โดยเชยจระทำกันเอง ขอบคุณสำเค้าภาพ',
            likes: 2,
            replies: []
        },
        {
            ...
            content: 'แพล่งๆกำไป สีเขา เลื่อนๆ ทั้งนั้น ถ่าไปที่ศูนย์แล้วเองด้วยครับ เซรม ม่นเลื่อน',
            likes: 7,
            replies: []
        },
        {
            ...
            content: 'น่ารักแล้วยังรักเมษตรอีก สุดยอดน้องแม่งคนไทยได้ดี ขอให้ใช้ชีวิตเจริญรุ่งเรืองการงานการเงินก้าวหน้ายิ่งๆขึ้น ว่าชอบ ติดตามครับ',
            likes: 1,
            replies: []
        }
    ];
    ...
    const CommentSection = () => {
        return (
            <div className="bg-white p-4 mt-4 rounded-lg">
                <h2 className="font-bold mb-4">ความคิดเห็น {comments.length} รายการ</h2>
                        ...
                        <div key={comment.id} className="flex gap-4">
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm text-gray-500">{comment.user.timeAgo}</span>
                                </div>
