                        ...
                        <div key={index} className="space-y-3 space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400">
                                    ...
                                    adipisicing elit. Similique, quos.
                                </p>
                            </div>
                        </div>
                    ))}
                    ...
                    {Array.from({ length: 6 }).map((_, index) => (
                        <div key={index} className="grid grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400">
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Molestias aspernatur
                                    ratione facere nisi totam enim eum, aut
                                    earum obcaecati dicta.
                                </p>
                            </div>
                        </div>
                    ))}
                ...
                <div className="grid grid-cols-5 gap-4 bg-white p-4 rounded-lg">
                    <div className="col-span-3 rounded-xl relative">
                        ...
                        <p className="absolute bottom-4 left-4 right-4 text-white">
                            ...
                            elit. Neque saepe obcaecati numquam temporibus vitae
                            autem! Sunt numquam nihil neque dicta.
                        </p>
                    </div>
                    <div className="col-span-2 space-y-2 h-[500px]">
                        {Array.from({ length: 5 }).map((_, index) => (
                            <div
                                key={index}
                                className="space-y-3 flex flex-row space-x-3"
                            >
                                <img
                                    src={`https://picsum.photos/10${index}/10${index}`}
                                    alt="Banner"
                                    className=" object-cover"
                                />
                                <div>
